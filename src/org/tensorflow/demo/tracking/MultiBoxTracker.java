  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      final String labelString =
        ...
        /*
        *  Now we're actually going to draw the box and cooresponding label.
        *  First we must determine which color to draw the box
        */
        ...
        /*
        *  Finally we must check which class was detected and determine whether
        *  we want to display this box or not
        */


        if (!recognition.title.equals("CBrownLeafSpot") && (!recognition.title.equals("CRedMite")) && numTracked >= MAX_BOXES) {
        canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
        borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);
        //Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
        logger.i("nObjects =  %d", numTracked);
      }
    }
  }
  ...
  public synchronized void onFrame(
    ...
    for (final TrackedRecognition recognition : copyList) {
      ...
      if (correlation < MIN_CORRELATION) {
        ...
        if (!recognition.title.equals("CBrownLeafSpot") && (!recognition.title.equals("CRedMite"))) {
            numTracked--;
        }
